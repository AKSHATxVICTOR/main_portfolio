    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <SectionHeading
          ...
          copy="Akshat is a Computer Science student specializing in Data Science at SRMIST. His work sits across data automation, Android development, and full-stack web tools, with a preference for clear architecture and measurable outcomes."
        />
          ...
          <motion.div variants={revealItem}>
            <GlassPanel className="h-full p-7 sm:p-9">
              ...
              <p className="mt-5 text-lg leading-8 text-text-secondary">
                He is pursuing B.Tech CSE in Data Science at SRMIST, balancing academic foundations with hands-on product work: automation scripts, finance utilities, and campus workflow tools.
              </p>
            </GlassPanel>
          </motion.div>
          <motion.div variants={revealItem}>
